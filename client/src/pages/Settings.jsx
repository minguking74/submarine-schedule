    ...
    <div>
      ...
      <div className="card">
        ...
        <form className="settings-form" onSubmit={saveFxRate}>
          <label>
            기준환율 (KRW per USD)
            <input type="number" value={fxRate} onChange={(e) => setFxRate(Number(e.target.value))} />
          </label>
          <button className="btn-sm btn-primary" type="submit" style={{ width: 'fit-content' }}>저장</button>
